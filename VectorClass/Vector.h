...
#define Z 2
	...
	class Vector
	{
		...
		template<typename coordinate_type1, size_t dimension>
		friend float dotProduct(const Vector<coordinate_type1, dimension>& v1, const Vector<coordinate_type1, dimension>& v2);
	...
	template<typename coordinate_type1, size_t dimensions>
	float dotProduct(const Vector<coordinate_type1, dimensions>& v1, const Vector<coordinate_type1, dimensions>& v2)
	{
